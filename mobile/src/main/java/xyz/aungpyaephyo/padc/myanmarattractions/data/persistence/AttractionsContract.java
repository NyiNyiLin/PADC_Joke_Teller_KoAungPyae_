...
public class AttractionsContract {
    ...
    public static final String PATH_ATTRACTIONS = "attractions"; //can assume as DataBase Table
    ...
    public static final class AttractionEntry implements BaseColumns {
        ...
        public static final String DIR_TYPE = //dir mean directory
        ...
        /*
        The following helper method depends on how u want to query data from database
         */
