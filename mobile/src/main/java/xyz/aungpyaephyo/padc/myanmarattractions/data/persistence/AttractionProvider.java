...
public class AttractionProvider extends ContentProvider {
    ...
    public static final int ATTRACTION = 100; //value is not important just number
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        //projection array list contain the required column name
        //selection contain condition (parameter pal not value )(for eg.(select * from table_name where ... ) where nout ka database htal ka bal har ko yu hmar lal par tal)
        Cursor queryCursor;
